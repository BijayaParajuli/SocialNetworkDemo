...
Route::post('/add_new_posts','PostController@add_posts')->name('add.new.posts');
Route::get('/edit_post/{post_id}','PostController@edit_user_post')->name('edit_users_post');  
Route::post('/update_post/{post_id}','PostController@update_user_post')->name('update_users_post'); 
Route::get('/delete/{post_id}','PostController@delete_post')->name('user.delete.post');  
